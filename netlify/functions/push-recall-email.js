exports.handler = async (event) => {
  ...
  const dashboardUrl = `https://app.batchdapp.com`;
  ...
  const html = `
    <div style="font-family:monospace;background:#080f12;color:#edfdf8;padding:40px;max-width:560px;margin:0 auto;border-radius:12px;">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:#6aaf9e;width:40%;">Severity</td>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:${severityColor};font-weight:600;">${severityLabel}</td>
        </tr>
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:#6aaf9e;">Reason</td>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:#edfdf8;">${reason}</td>
        </tr>
        <tr>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:#6aaf9e;">Issued by</td>
          <td style="padding:8px 0;border-bottom:1px solid #163d37;font-size:11px;color:#edfdf8;">${manufacturerName}</td>
        </tr>
        <tr>
          <td style="padding:8px 0;font-size:11px;color:#6aaf9e;">Est. units on shelf</td>
          <td style="padding:8px 0;font-size:11px;color:#edfdf8;font-weight:600;">${affectedUnits} units across your stores</td>
        </tr>
      </table>
      ...
      <a href="${dashboardUrl}" style="display:inline-block;background:#34d399;color:#080f12;font-weight:700;font-size:14px;padding:14px 28px;border-radius:8px;text-decoration:none;margin-bottom:24px;">
        View recall in dashboard →
      </a>

      <p style="font-size:11px;color:#6aaf9e;line-height:1.6;">
        You are receiving this because your organisation is a registered trading partner on Batch'd.<br>
  ...
  // Send to all affected retailer admins
